...
export const TlOverviewTrMatchmakingWhiteBg: React.FC = () => {
  return (
    <main className=" flex flex-col bg-surface" style={{"backgroundColor": "#FFFFFF"}}>
...
<div className="col-span-12 lg:col-span-4 bg-surface-container-lowest border border-outline-variant p-lg flex flex-col justify-between h-48" style={{"backgroundColor": "#FFFFFF"}}>
<div>
...
<div className="w-full h-2 bg-surface-container rounded-full overflow-hidden" style={{"backgroundColor": "#FFFFFF"}}>
...
<div className="bg-surface-container border border-outline-variant p-md" style={{"backgroundColor": "#FFFFFF"}}>
...
<span className="px-sm py-xs bg-surface-container-high rounded font-label-md text-on-surface-variant cursor-pointer" style={{"backgroundColor": "#FFFFFF"}}>Filter By Role</span>
<span className="px-sm py-xs bg-surface-container-high rounded font-label-md text-on-surface-variant cursor-pointer" style={{"backgroundColor": "#FFFFFF"}}>Availability</span>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-md">

<div className="p-md border border-outline-variant bg-surface-container-lowest hover:bg-surface-container-low transition-colors group" style={{"backgroundColor": "#FFFFFF"}}>
...
<div className="p-md border border-outline-variant bg-surface-container-low transition-colors border-dashed" style={{"backgroundColor": "#FFFFFF"}}>
<div className="flex items-center gap-md mb-md">
<div className="relative">
...
<div className="p-md border border-outline-variant bg-surface-container-lowest flex items-center justify-center opacity-60" style={{"backgroundColor": "#FFFFFF"}}>
...
<section className="bg-surface-container-lowest border border-outline-variant overflow-hidden" style={{"backgroundColor": "#FFFFFF"}}>
<div className="px-md py-sm bg-surface-container border-b border-outline-variant flex justify-between items-center" style={{"backgroundColor": "#FFFFFF"}}>
...
<thead className="bg-surface-container-low text-on-surface-variant font-label-md text-[10px]" style={{"backgroundColor": "#FFFFFF"}}>
<tr>
...
export default TlOverviewTrMatchmakingWhiteBg;
