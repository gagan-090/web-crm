          ...
          <div className="overflow-x-auto border border-gray-100 rounded-lg">
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-gray-100">
                {isLoading ? (
                  <tr><td colSpan={6} className="px-3 py-8 text-center text-gray-400 italic">Loading applicants…</td></tr>
                ) : applicants.length === 0 ? (
                  <tr><td colSpan={6} className="px-3 py-8 text-center text-gray-400 italic">No applicants for this job yet.</td></tr>
                ) : (
                  applicants.map((a) => (
                    <tr key={a.apply_id} className="hover:bg-gray-50/60">
